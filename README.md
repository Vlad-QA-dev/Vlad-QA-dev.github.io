...
<table>
  <tr>
    <td width="200px" valign="top">
      <img src="VladQA.jpg" width="180px" style="border-radius: 12px; border: 2px solid #ccc;" alt="Vlad photo">
    </td>
    <td valign="top">
      <h1>Привет, меня зовут Влад 👋</h1>
      <h3>QA-инженер. 
      <p>Люблю порядок в логах,  отчёты и тесты, покрывающие прод как одеяло бабушки.</p>
    </td>
  </tr>
</table>
